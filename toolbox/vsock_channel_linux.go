...
// its vsock connection to the ESX hypervisor (CID 2, port 976).
//
...
//
// This design is compatible with both real ESX hypervisors (native AF_VSOCK
// kernel support) and govmomi/simulator container-backed VMs (seccomp-based
// AF_VSOCK interception that replaces the FD with a Unix socketpair).
//
